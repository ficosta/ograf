...
.breaking-line.show {
  ...
  transform: scaleX(1);
          ...
          <TutorialManifest slug="breaking-news" title="Breaking News" manifest={MANIFEST} intro="Notice stepCount: 0 — that's how OGraf declares fire-and-forget graphics. The renderer expects playAction to run the full lifecycle and return." />
