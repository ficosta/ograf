        ...
        <div className="py-16">
          ...
          <nav className="mt-10 text-sm" aria-label="quick links">
            <div className="-my-1 flex justify-center gap-x-6">
              <Link to="/get-started" className="inline-block rounded-lg px-2 py-1 text-sm text-slate-700 hover:bg-slate-100 hover:text-slate-900">Get Started</Link>
              ...
              <a href="https://ograf.tools" className="inline-block rounded-lg px-2 py-1 text-sm text-slate-700 hover:bg-slate-100 hover:text-slate-900">Tools</a>
              <a href="https://ograf.ebu.io" target="_blank" rel="noopener noreferrer" className="inline-block rounded-lg px-2 py-1 text-sm text-slate-700 hover:bg-slate-100 hover:text-slate-900">Spec</a>
            </div>
          </nav>
        </div>
        <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
          <div className="flex gap-x-6">
            <a href="https://github.com/ebu/ograf" className="group" aria-label="OGraf on GitHub" target="_blank" rel="noopener noreferrer">
